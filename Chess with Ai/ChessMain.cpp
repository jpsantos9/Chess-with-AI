...
void userManual(){
    cout<<"User Manual\n"<<endl;
    cout<<"How to launch the game?\n";
    cout<<"  1) Open CodeBlocks\n";
    cout<<"  2) Drag the ChessProject file to CodeBlocks\n";
    cout<<"  or\n";
    cout<<"  2) Click file\n";
    cout<<"  3) Click open\n";
    cout<<"  4) Find ChessProject file\n";
    cout<<"  5) Open ChessProject\n"<<endl;
    cout<<"How to play the game?\n";
    cout<<"  1) Enter [1] to play versus the AI\n";
    cout<<"  2) Enter [2] to play with another player\n";
    cout<<"  3) Enter [3] to display the user's manual\n";
    cout<<"  4) Enter [4] to quit the game \n"<<endl;
    cout<<"How to play vs AI?\n";
    cout<<"  1) Enter the piece you will move \n";
    cout<<"  2) Enter your move\n";
    cout<<"  3) Wait for the AI's move\n";
    cout<<"  4) Repeat until the king is defeated \n"<<endl;
    cout<<"How to play with another player?\n" ;
    cout<<"  1) Start with white player\n";
    cout<<"  2) Enter piece for white\n";
    cout<<"  3) Enter move \n";
    cout<<"  4) Change to next player\n";
    cout<<"  5) Enter piece for black\n";
    cout<<"  6) Enter move\n";
    cout<<"  7) Repeat until one king is defeated\n";
                            ...
                            //if diagonal move, there shoudl be enemy
                                ...
                                if (checkLoad(x, y, board)){
                                    ...
                                    //if other color
                                        ...
                                        //check if valid move first before eating
                        ...
                        do {
                            ...
                            if (checkLoad(x, y, board)){
                                ...
                                //if black
                                    ...
                                    //check is valid move before eating
                                    if (rMoves(x, y, chessP[test])){
                                        //find the prey number
